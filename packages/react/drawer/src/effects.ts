...
import type { DrawerMachine, DrawerOptions } from '@dunky.dev/drawer'
...
type DrawerEffect = ComponentEffect<DrawerMachine, DrawerOptions>
...
const syncControlledOpen: DrawerEffect = [
  (machine, props) => {
...
// focus is.
const trackEscape: DrawerEffect = [
  (machine, props) => {
...
export const drawerEffects: DrawerEffect[] = [syncControlledOpen, trackEscape]
