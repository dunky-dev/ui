...
- One shared registry and one `popstate` listener realm-wide — even across
  duplicate copies of this module — the one-pop-one-guard ordering is the
  whole unwinding contract.
